...
class LSTMGANModel(object):
    ...
    def train_batch(self, xbatch, ybatch):
        ...
        # train discriminator
        d_loss, _ , outputs = self.session.run([self.d_loss, self.train_d, self.d1_outputs], feed_dict={self.xbatch: xbatch, self.ybatch: ybatch, self.initial_state: initial_state})
