...
class LSTMGANModel(object):
    ...
    def discriminator(self, xbatch, initial_state):
        ...
        with tf.variable_scope("discriminator"):
            ...
            rnn_out_W = tf.get_variable("rnn_out_W", tf.random_normal((self.config.lstm_size, 1), stddev=0.01))
            rnn_out_B = tf.get_variable("rnn_out_B", tf.random_normal((1,), stddev=0.01))
